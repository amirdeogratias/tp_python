...
def menu_consulter(catalogue):
    ...
    while True:
        ...
        if choix == "a":
            action_lister(catalogue, lister_artistes)
        elif choix == "b":
            action_rechercher(catalogue, rechercher_artiste)
        elif choix == "c":
            action_detail(catalogue, afficher_detail_artiste)
        elif choix == "r":
            break
        else:
...
def action_lister(catalogue, fn_lister):
    """
...
def action_rechercher(catalogue, fn_rechercher):
    """
...
def action_detail(catalogue, fn_detail):
    """
    ...
    try:
        artiste = fn_detail(catalogue, id_artiste)
    except ValueError as e:
        print(f"  Erreur : {e}")
        return
    print()
...
def menu_ajouter_artiste(catalogue, chemin_json):
    ...
    """
    from label import ajouter_artistes, sauvegarder_catalogue, lister_artistes
    while True:
        print("\n" + "-" * 45)
        print("  2. Ajouter un artiste")
        print("-" * 45)
        ...
        choix = input("Votre choix : ").strip().lower()
        if choix == "a":
            catalogue = action_saisir_artiste(
                catalogue, chemin_json, ajouter_artistes, sauvegarder_catalogue
            )
        elif choix == "r":
            break
        else:
...
def action_saisir_artiste(catalogue, chemin_json, fn_ajouter, fn_sauvegarder):
    """
    ...
    Args:
        ...
        fn_ajouter (callable): Fonction ajouter_artistes de label.py.
...
def menu_ajouter_album(catalogue, chemin_json):
    """
...
def action_saisir_album(catalogue, chemin_json, fn_ajouter_album, fn_sauvegarder):
    """
...
def menu_statistiques(chemin_json, chemin_csv):
    """
    ...
    while True:
        ...
        choix = input("Votre choix : ").strip().lower()
        if choix == "a":
            action_top5(chemin_json)
        elif choix == "b":
            action_moyenne_genre(chemin_json)
        elif choix == "c":
            action_albums_annee(chemin_json)
        elif choix == "d":
            action_exporter(chemin_json, chemin_csv)
        elif choix == "r":
            break
        else:
...
def action_moyenne_genre(chemin_json):
    """
...
def action_albums_annee(chemin_json):
    """
...
def action_exporter(chemin_json, chemin_csv):
    """
...
def main():
    ...
    while True:
        ...
        if choix == "1":
            ...
            catalogue = menu_ajouter_album(catalogue, chemin_json)
        elif choix == "4":
            menu_statistiques(chemin_json, chemin_csv)
        elif choix == "5":
